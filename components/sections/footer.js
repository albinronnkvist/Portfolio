    ...
    <div className="dark:bg-black-dark bg-primary-dark w-full pt-12 pb-6 mt-12 md:mt-6">
      <div className="text-center">
        ...
        <div className="flex flex-row gap-8 text-xl justify-center items-center mt-4">
          ...
          <a href="https://stackoverflow.com/users/15634040/hackarmannen" target="_blank" rel="noreferrer" className="text-white" aria-label="Stack Overflow"><i className="bi bi-stack-overflow"></i></a>
